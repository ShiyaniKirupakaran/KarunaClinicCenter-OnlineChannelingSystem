...
echo "<tr><th>Lab Assistant_id</th><th>FirstName</th><th>Lastname</th><th>Address</th><th>Phone No</th><th>Email</th><th>Admin_id</th></tr>";
while($row=mysqli_fetch_array($sqldata,MYSQLI_ASSOC)){
	
	echo "<tr><td>";
	echo $row['Labassistant_id'];
	echo "</td><td>";
	echo $row['First_Name'];
	echo "</td><td>";
	echo $row['Last_Name'];
...
<div class="View col-12">
	...
	<a href="L_Insert.php"> <button  class="button" type="submit" class="btn btn-info" align="center" style="border-radius: 10px 10px 10px 10px;">Insert</button></a>  

   <a href="L_View.php"><button   class="button" type="submit" class="btn btn-info" align="center" style="border-radius: 10px 10px 10px 10px;">Edit</button></a>
	
   <a href="L_View.php"><button   class="button" type="submit" class="btn btn-info" align="center" style="border-radius: 10px 10px 10px 10px;">Delete</button></a>
   </div>
	</div>
