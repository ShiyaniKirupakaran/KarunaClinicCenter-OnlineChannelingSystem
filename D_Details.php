...
echo "<tr><th>Doctor_id</th><th>FirstName</th><th>Lastname</th><th>Category</th><th>Phone No</th><th>Address</th><th>Email</th><th>Admin_id</th></tr>";
...
?>
	...
	<a href="D_Insert.php"> <button  class="button" type="submit" class="btn btn-info" align="center" style="border-radius: 10px 10px 10px 10px;">Insert</button></a>  

   <a href="D_View.php"><button   class="button" type="submit" class="btn btn-info" align="center" style="border-radius: 10px 10px 10px 10px;">Edit</button></a>
   </div>
	</div>
